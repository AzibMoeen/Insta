...
const LeftSidebar = () => {
    ...
    const logoutHandler = async () => {
        try {
            const res = await axios.get('https://sea-lion-app-hc6ju.ondigitalocean.app/api/v1/user/logout', { withCredentials: true });
            if (res.data.success) {
    ...
    const handleSearch = async () => {
        try {
            const res = await axios.get('https://sea-lion-app-hc6ju.ondigitalocean.app/api/v1/user/search', {
                params: {
                    query: searchQuery
                }
            });
